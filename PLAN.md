...
- [ ] You need to succinctly and simply and clearly cover the content
...
- [ ] Please base the content off of that which is found in the course slides
and in the course text book. You need to make sure that the content flows in
the same order as the material in the book.
- [ ] Make sure to review the content from last week, which is in the
