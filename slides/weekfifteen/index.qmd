...
- {{< iconify fa6-solid trophy >}} **Classical definition**: NP-complete means
all NP problems polyreduce to it
- {{< iconify fa6-solid lightbulb >}} **Key property**: These are the "hardest
problems in NP"
- {{< iconify fa6-solid circle-check >}} **Must be in NP**: The problem itself
is in NP
- {{< iconify fa6-solid link >}} **Universal target**: Every NP problem reduces
to it
- {{< iconify fa6-solid rocket >}} **Implication**: Solving one solves them
all!

:::

::: {.fragment .fade .boxed-content style="font-size: 0.65em;"}
...
polynomial time! See the benefit?
...
NP-complete, we can prove others are NP-complete by reducing from it. Many
results follow!
...
**NP-completeness is transitive**: $A$ is NP-complete and $A \leq_P B$
and $B \in$ NP, then $B$ is NP-complete. We now build a web of NP-complete
problems!
...
polyequivalent to any NP-complete problem; note that this moves in both
directions!
- {{< iconify fa6-solid link >}} **Polyequivalence**: Bidirectional reductions
between problems
- {{< iconify fa6-solid lightbulb >}} **Key insight**: All NP-complete problems
are equally hard
- {{< iconify fa6-solid microscope >}} **Implication**: Solving one solves them
all
...
- {{< iconify fa6-solid trophy >}} **NP-hard definition**: All NP problems
polyreduce to it
- {{< iconify fa6-solid question >}} **Key difference**: Problem itself might
not be in NP
- {{< iconify fa6-solid microscope >}} **Could be harder**: Outside NP entirely
...
**NP-hard is more general than NP-complete**: NP-complete problems must be in
NP, but NP-hard don't have that requirement. So NP-hard is "at least as hard as
NP-complete"!
...
**Understanding the hierarchy**: P $\subseteq$ NP $\subseteq$ Expo is known,
but whether these are proper subsets is still open. NP-complete and NP-hard
problems are believed to be intractable but (as of yet) there is no formal
proof!
...
::: {.fragment .fade style="margin-top: -0.5em; font-size: 0.8em;"}
...
::: {.fragment .fade style="margin-top: -0.35em; font-size: 0.8em;"}

**Template for NP-completeness proofs**: (1) construct polytime verifier, (2)
describe polyreduction from known NP-complete problem, (3) verify all three
reduction conditions. Unless necessary, follow this template every time!

:::

# Good and bad news!

::: {.incremental style="margin-top: -0.5em; font-size: 0.7em;"}
...
- {{< iconify fa6-solid check-circle >}} **Proof technique**: Show NP,
then polyreduce from NP-complete problem
